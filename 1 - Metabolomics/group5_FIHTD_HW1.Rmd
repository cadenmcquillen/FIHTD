...
```{r}
print("Top 5 significantly associated with male:")
for (metab in top.male.met){
  mateb_info <- annotations[annotations$name == metab,]
  metab_sub_pathway <- mateb_info$Sub_pathway
  print(paste(metab, ": ", metab_sub_pathway))
}
print('\n')
print("Top 5 significantly associated with female:")
for (metab in top.female.met){
  mateb_info <- annotations[annotations$name == metab,]
  metab_sub_pathway <- mateb_info$Sub_pathway
  print(paste(metab, ": ", metab_sub_pathway))
}
...
insig_metab = length(which(dat_pcor_adj$sig == "NA"))
```
