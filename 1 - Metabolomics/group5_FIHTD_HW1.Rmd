...
norm_samples_boxplot <-boxplot(sig_metabs_male, main = "Top 10 Sig Metabolites in Male Samples", ylab = "log(concentration)" , outline = FALSE, show.names=TRUE, las=2, col=colors)
legend(x = "topright", legend=c("highly associated with male", "highly associated with female"),
col=c("red", "blue"), lty=c(1, 1), lwd=c(3,3), cex=0.8)
norm_samples_boxplot <-boxplot(sig_metabs_female, main = "Top 10 Sig Metabolites in Female Samples", ylab = "log(concentration)" , outline = FALSE, show.names=TRUE, las=2, col=colors)
legend(x = "topright", legend=c("highly associated with male", "highly associated with female"),
col=c("red", "blue"), lty=c(1, 1), lwd=c(3,3), cex=0.8)
```
