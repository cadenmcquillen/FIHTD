...
ggplot(results, aes(x=-log10(adj.P.Val), y=subpathway, label=subpathway)) + 
  ...
  labs(title="Sub Pathways: Females vs Males") + geom_vline(xintercept = 1.30102999566) 
...
ggplot(results2, aes(x=-log10(adj.P.Val), y=superpathway, label=superpathway)) + 
  geom_point(stat='identity', aes(col =plotcolor), size=3 )  +
  scale_color_manual(name="Log FC", 
                     labels = c("Female", "Male"), 
                     values = c("Female" = "red", "Male"="blue")) + 
  labs(title="Super Pathways: Females vs Males") + geom_vline(xintercept = 1.30102999566) #add line for significance 
